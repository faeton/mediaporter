...
6. **TV episodes need the full set**: `tv_show_name`, `sort_tv_show_name`, `season_number`, `episode_number`, `episode_sort_id`, plus `artist`/`album`/`album_artist` (+ sorts). Missing `episode_sort_id` → "0." prefix in TV app.
